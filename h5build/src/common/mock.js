...
export const RIGHT_ENTRIES = [
  { key: 'ai', label: 'AI自测', icon: 'fa-solid fa-face-grin-tongue', color: '#389a82', bg: '#d4f5ee' },
  { key: 'consult', label: '免费问诊', icon: 'fa-solid fa-comments', color: '#389a82', bg: '#d4f5ee' },
  { key: 'expert', label: '专家预约', icon: 'fa-solid fa-user-doctor', color: '#389a82', bg: '#d4f5ee', quota: 3 },
  { key: 'video', label: '视频问诊', icon: 'fa-solid fa-video', color: '#389a82', bg: '#d4f5ee', quota: 6 },
  { key: 'accompany', label: '陪诊', icon: 'fa-solid fa-hand-holding-heart', color: '#389a82', bg: '#d4f5ee', quota: 12 },
  { key: 'psycho', label: '心理评估', icon: 'fa-solid fa-heart-pulse', color: '#389a82', bg: '#d4f5ee' },
  { key: 'nurse', label: '上门换药', icon: 'fa-solid fa-house-medical', color: '#389a82', bg: '#d4f5ee' }
]
